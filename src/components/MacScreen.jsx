const MacScreen = ({ projectInfo }) => {
  ...
  return (
    <div className=" flex-shrink-0 w-auto  max-w-md border-2 border-gray-300 rounded-lg shadow-lg relative bg-white overflow-hidden transform transition duration-300 hover:cursor-pointer">
      ...
      <a href={link} target='_blank'>
        <div
          className="flex items-center justify-center bg-cover bg-center w-full h-auto relative overflow-hidden text-white-100"
        >
